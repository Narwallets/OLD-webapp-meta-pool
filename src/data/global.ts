...
import * as sha256 from "../wallet-api/lib/sha256.js"

import { localStorageRemove, localStorageRetrieve, localStorageSave, localStorageSet, localStorageGet } from "./util.js";
...
export let DiversifyingContractAccount:string="diversifying-staking-pool.guildnet"
...
export async function recoverState():Promise<void> {
  State = await localStorageRetrieve("State", "S", EmptyState)
}
...
export function getNetworkAccountsCount() {
  const accounts = SecureState.accounts[""]
